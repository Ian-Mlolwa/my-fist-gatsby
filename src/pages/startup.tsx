        ...
        <div style={{ display: "grid" }} className="h-screen">
          ...
          >
            <div className="text-white mt-10 w-2/3">
              <h1 className="text-5xl font-semibold mb-11">StartUp</h1>
              <br />
              <br />
              ...
              <div>
                <StaticImage src="../assets/statup.png" alt="pg4" />
                <Footer />
              </div>
            </div>
          </div>
...
export const Head = () => <Seo title="StartUp" />;
